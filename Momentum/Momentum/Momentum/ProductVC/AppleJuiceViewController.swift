//
//  AppleJuiceViewController.swift
//  Momentum

import UIKit

class AppleJuiceViewController: UIViewController {
    ...
    lazy var imageView = UIImageView(image: UIImage(named: "AppleJuice"))
    ...
    override func viewDidLoad() {
        ...
        //MARK: Описание
        text.text = "Яблочный сок — сок, выжатый из яблок. Сладкий вкус обусловлен содержанием в яблоках натурального сахара. Считается, что впервые делать яблочный сок стали в Англии, — упоминания о нём встречаются ещё в документах англосаксонской эпохи!"
