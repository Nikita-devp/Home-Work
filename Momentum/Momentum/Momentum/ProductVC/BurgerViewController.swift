...
class BurgerViewController: UIViewController {
    ...
    lazy var imageView = UIImageView(image: UIImage(named: "Burger"))
    ...
    override func viewDidLoad() {
        ...
        //MARK: Описание
        text.text = "Бургер — закрытый бутерброд (сендвич), состоящий из разрезанной пополам круглой булочки, между половинками которой укладывается начинка из разогретой плоской котлеты, соуса и овощей!"
