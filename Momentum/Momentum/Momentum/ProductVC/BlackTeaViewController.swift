//
//  BlackTeaViewController.swift
//  Momentum

import UIKit

class BlackTeaViewController: UIViewController {
    ...
    lazy var imageView = UIImageView(image: UIImage(named: "BlackTea"))
    ...
    override func viewDidLoad() {
        ...
        //MARK: Описание
        text.text = "ЛЧерный чай, известный как хохча или «красный чай» в Китае, за его богатый, красноватый оттенок, является полностью окисленным, в отличие от улуна, зеленого или белого чая и отличается по вкусу. До середины XVII в. в Китае потребляли только зеленый чай (не окисленный) и улун (полу-окисленный)!"
