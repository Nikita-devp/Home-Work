...
//  Momentum
//
//  Created by Злата Лашкевич on 16.04.25.
//
...
class GreenViewController: UIViewController {
    ...
    lazy var imageView = UIImageView(image: UIImage(named: "Latte"))
    ...
    override func viewDidLoad() {
        ...
        //MARK: Описание
        text.text = "Латте — самый большой и самый молочный кофейный напиток на основе эспрессо. Подойдёт для тех, кто не любит яркий вкус кофе. Его готовят в чашку объёмом 250–300 мл и используют одну порцию эспрессо. Остальной объем напитка составляет молоко и немного молочной пены!"
