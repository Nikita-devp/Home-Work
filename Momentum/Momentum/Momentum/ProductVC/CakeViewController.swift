...
class CakeViewController: UIViewController {
    ...
    lazy var imageView = UIImageView(image: UIImage(named: "CakeInStore"))
    ...
    override func viewDidLoad() {
        ...
        //MARK: Описание
        text.text = "Пирожные - кондитерское изделие небольшого размера из сладкого теста, с кремовой, фруктово-ягодной или шоколадной начинкой!"
