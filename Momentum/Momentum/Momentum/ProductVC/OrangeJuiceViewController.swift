//
//  OrangeJuiceViewController.swift
//  Momentum

import UIKit

class OrangeJuiceViewController: UIViewController {
    ...
    lazy var imageView = UIImageView(image: UIImage(named: "OrangeJuice"))
    ...
    override func viewDidLoad() {
        ...
        topLabel.text = "Апельсиновый сок"
        ...
        nameLabel.text = "Апельсиновый сок"
        ...
        //MARK: Описание
        text.text = "Апельсиновый сок — источник витамина С (аскорбиновой кислоты), калия, фолиевой кислоты (Витамин B9). Апельсиновый сок также содержит флавоноиды, которые благотворно влияют на здоровье человека. Бывает с мякотью. Апельсиновый сок является эффективным противораковым, мочегонным, кроветворным средством!"
        ...
        kBJUStack.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 10).isActive = true
