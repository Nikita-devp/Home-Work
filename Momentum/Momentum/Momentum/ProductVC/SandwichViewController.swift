...
class SandwichViewController: UIViewController {
    ...
    lazy var imageView = UIImageView(image: UIImage(named: "Sandwich"))
    ...
    override func viewDidLoad() {
        ...
        //MARK: Описание
        text.text = "Сэ́ндвич — вид бутерброда, состоящего из двух кусочков хлеба и какой-либо начинки между ними (закрытый бутерброд). Бутерброд из одного кусочка хлеба в английском языке называется открытым сэндвичем!"
