...
class CapucinoViewController: UIViewController {
    ...
    lazy var imageView = UIImageView(image: UIImage(named: "Capucino"))
    ...
    override func viewDidLoad() {
        ...
        //MARK: Описание
        text.text = "Погрузитесь в мир истинного удовольствия с нашим капучино с шоколадом. Насыщенный аромат свежемолотого кофе, нежная воздушная пенка и неповторимое сочетание шоколадных нот создадут неповторимый вкусовой опыт. Роскошное сочетание кофе и шоколада, которое подарит вам незабываемые моменты наслаждения. Позвольте себе роскошь и великолепие в каждом глотке — наш капучино с шоколадом!"
