...
class RegisterViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        acceptButton.addTarget(self, action: #selector(registerButtonTrapped), for: .touchUpInside)
        
        
        // кнопка польз. согл.
        registerButton.setTitle("Уже есть аккаунт", for: .normal)
        ...
        registerButton.addTarget(self, action: #selector(goToAuth), for: .touchUpInside)
    ...
    @objc func registerButtonTrapped(){
